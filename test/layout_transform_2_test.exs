...
#defmodule Transforms.Simple.TWO.Test do
  #use ExUnit.Case
  ...
  #test "append_text" do
    #model = [{:action_title, "Creating "}]
    #assert_eq AppendText.transform(model) , [{"h1", [{"id", "action_title"}], ["Creating The word \"Editing\" or \"Creating\" should be introduced before thisCreating "]}]
  #end

  #test "replace_text" do
    #model = [{:action_title, "Creating "}, {:replacement, "new text"}]
    #assert_eq ReplaceText.transform(model) , [{"h1", [{"id", "action_title"}], ["Creating The word \"Editing\" or \"Creating\" should be introduced before thisCreating "]}]
  #end
